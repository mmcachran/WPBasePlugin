 ...
 */
abstract class AbstractPostType implements \WPBasePlugin\RegistrationInterface {
	/**
	...
	public function get_labels() {
		...
		$labels = [
			...
			// Translators: %1$s The singular label.
			'new_item'           => sprintf( esc_html__( 'New %1$s', 'wpbaseplugin' ), $singular_label ),

			// Translators: %1$s The singular label.
			'view_item'          => sprintf( esc_html__( 'View %1$s', 'wpbaseplugin' ), $singular_label ),
			...
			// Translators: %1$s The plural label.
			'parent_item_colon'  => sprintf( esc_html__( 'Parent %1$s:', 'wpbaseplugin' ), $plural_label ),
		];
