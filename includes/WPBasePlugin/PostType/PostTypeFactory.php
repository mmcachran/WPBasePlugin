 ...
 *
 * All post types supported by WPBasePlugin are declared here.
 *
 * Usage:
 *
 * ```php
 ...
 */
class PostTypeFactory implements \WPBasePlugin\FactoryInterface {
	/**
	 ...
	 * @return \WPBasePlugin\AbstractPostType The post type instance.
	 */
	 ...
	 *
	 * @param string $post_type          The post type name.
	 * @return \WPBasePlugin\AbstractPostType The post type object.
	...
	public function build( $post_type ) {
		...
		if ( 0 !== strpos( $class, 'WPBasePlugin' ) ) {
			$class = 'WPBasePlugin\PostType\\' . $class;
		}
