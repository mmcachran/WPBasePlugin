...
/**
 * Test Case class that extends the PHPUnit_Extensions_Database_TestCase class but also includes needed functionality from the WP_UnitTestCase class like rolling back the DB before each test.
 */
class WP_DBUnit_TestCase extends \PHPUnit_Extensions_Database_TestCase {
	...
	public function getConnection() {
		// Abstract, will be defined in classes that extend this one.
	}
